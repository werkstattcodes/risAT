...
The RIS API returns metadata in German. risAT converts these to
snake_case column names. The table below documents all observed columns
and their planned English translations, grouped by scope.
