...
`risAT` is an R package for querying Austrian court decisions from the RIS OGD REST API v2.6 (`/Judikatur`).
...
Search functions automatically iterate through all RIS pages and return all
results in scope. Returned tibbles include:
- pagination columns: `page`, `per_page`
- `content_urls`
- `app_metadata`
