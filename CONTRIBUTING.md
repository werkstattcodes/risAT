...
This outlines how to propose a change to risAT. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("werkstattcodes/risAT", fork = TRUE)`.
...
Please note that the risAT project is released with a [Contributor Code
of Conduct](https://werkstattcodes.github.io/risAT/CODE_OF_CONDUCT.md).
